<div class="rdp-header sticky-top" id="rdp-header">
			...
			<nav class="bds-c-navbar__brand d-flex flex-row align-items-center">
				<a href="/" aira-label="Home">
					<span aria-label="odrde" style="display:flex;align-items:flex-end;justify-content:center;gap:8px;">
						...
						<span class="fw-bold fs-6">Order Delivery</span>
					</span>
				</a>
			</nav>
				...
				{{-- <div class="bds-c-btn-cursor bds-c-btn-cursor--layout-default">
					<form method="POST" action="{{ route('logout') }}">
						...
						<a
							href="{{ route('logout') }}"
							onclick="event.preventDefault(); this.closest('form').submit();"
							class="bds-c-btn bds-c-btn-primary bds-c-btn--size-small bds-is-idle bds-c-btn--layout-default zi-surface-base"
							role="button"
						>
							<span class="bds-c-btn__idle-content">
								<span class="bds-c-btn__idle-content__label">
