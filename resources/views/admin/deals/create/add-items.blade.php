...
<div class="row">
	<div class="col-xxl">
		<div class="card">
			<div class="card-body">
				@if (session()->get('deal.info', []))
				@php
				extract(session()->get('deal.info', []));
				@endphp
				<div class="card mb-4">
					<div class="row g-0">
						<div class="col-md-3">
							...
							<img
								...
								src='{{ "/images/vendors/{$vendor}/deals/250x250/{$banner}" }}'
								alt="{{ $name }}"
								title="{{ $name }}"
								style="width:200px;"
							>
				...
				@endif
				<form method="POST" action="{{ route('deal.add-items') }}">
					@csrf
					<input
						type="hidden"
						name="selected_items"
					...
					<div class="row justify-content-end">
						<div class="col-sm-10 text-end">
							<a class="btn btn-secondary me-1" href="{{ route('deal.create', $vendor) }}">
								Previous
							</a>
