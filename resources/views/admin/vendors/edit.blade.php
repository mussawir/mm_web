					...
					<div class="row mb-3">
						<div class="col-sm-6">
							...
							<input
								...
								aria-required='true'
								value="{{ old('shop_number', $vendor->shop_number) }}"
							>
						...
						<div class="col-sm-6">
							...
							<textarea class="form-control @error('full_address') is-invalid @enderror" name="full_address" id="full_address" rows="4" placeholder="Enter Full Address">{{ old('full_address', $vendor->full_address) }}</textarea>
					...
					<div class="row mb-3">
						<div class="col-sm-6">
							...
							<input
								...
								aria-required='true'
								value="{{ old('current_balance', $vendor->current_balance) }}"
							>
						...
						<div class="col-sm-6">
							...
							<input
								...
								aria-required='true'
								value="{{ old('points_in_hand', $vendor->points_in_hand) }}"
							>
					...
					<div class="row mb-3">
						<div class="col-sm-6">
							...
							<input
								...
								aria-required='true'
								value="{{ old('date_joining', $vendor->date_joining) }}"
							>
						...
						<div class="col-sm-6">
							...
							<input
								...
								aria-required='true'
								value="{{ old('primary_contact', $vendor->contact_number_primary) }}"
							>
					...
					<div class="row mb-3">
						<div class="col-sm-6">
							...
							<input
								...
								aria-required='true'
								value="{{ old('secondary_contact', $vendor->contact_number_sec) }}"
							>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-6">
							...
							<input
								...
								aria-required='true'
								value="{{ old('delivery_free_after', $vendor->delivery_free_after) }}"
							>
					...
					<div class="row mb-3">
						<div class="col-sm-6">
							...
							<input
								...
								aria-required='true'
								value="{{ old('delivery_charges', $vendor->delivery_charges) }}"
							>
						...
						<div class="col-sm-6">
							...
							<input
								...
								aria-required='true'
								value="{{ old('minimum_delivery_amount', $vendor->minimum_delivery_amount) }}"
							>
					...
					<div class="row mb-3">
						{{-- <div class="col-sm-6">
							...
							<select class="form-select @error('vendor_type') is-invalid @enderror" name='vendor_type' id='vendor_type' aria-required='true'>
								...
								<option value="{{ $vendorType->id }}" {{ old('vendor_type', $vendor->vendor_type_id) == $vendorType->id ? 'selected' : '' }}>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-6">
							...
							<input
								...
								value="{{ old('twitter', $vendor->twitter_account) }}"
							>
