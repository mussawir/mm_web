          ...
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <h3 class="mb-0">Approved Shop</h3>
              </div>
              <!-- Card body -->
              <div class="card-body">
            @foreach ($shop as $info )
                <form action="{{url('/admin/update/shop/'.$info->id)}}" method="post" enctype="multipart/form-data">
                     @CSRF
                  <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3" {{ $errors->has('sale_type') ? 'has-error' : '' }}>
                      ...
                      <input type="text" class="form-control" id="validationCustomUsername" name="sale_type" placeholder="Please enter sale types" aria-describedby="inputGroupPrepend">
                     ...
                     <div class="form-row">
                      ...
                      <input type="text" class="form-control" id="validationCustomUsername" name="shop_address" placeholder="Please enter shop Address" value="{{$info->address != null ? $info->address : null }}" aria-describedby="inputGroupPrepend">
                    ...
                    <div class="col-md-4 mb-3" {{ $errors->has('points_balance') ? 'has-error' : '' }}>
                      ...
                      <input type="text" class="form-control" id="validationCustom01" name="points_balance" placeholder="Please enter points balance" >
                  ...
                  <div class="form-row">
                      ...
                      <input type="number" class="form-control" id="validationCustom01" name="payment" placeholder="Please enter payment" >
