					...
					<td>
						...
						{{-- <div class="dropdown">
							...
							<div class="dropdown-menu">
								...
								@if ($order->order_type == 1)
								<a href="/admin/dashboard/deliver/{{ $order->id }}" onclick="return confirm('Are you sure?')" class="dropdown-item d-flex align-items-center gap-1">
									<i class='bx bxs-truck'></i>
									Delivery
								</a>
								@elseif ($order->order_type == 2)
								<a href='javascript:void(0)' class="dropdown-item d-flex align-items-center gap-1" data-bs-toggle="modal" data-bs-target="#pickupModal" data-order-id="{{ $order->id }}">
									<i class='bx bxs-truck'></i>
									Picked Up
								</a>
								@endif
