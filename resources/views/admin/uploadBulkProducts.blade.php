        ...
        <div class="col">
          ...
          <div class="card">
              ...
              <div class="card-body">
                 ...
                 <form action="{{url('/admin/upload-store-items/store/'.$id)}}" method="post" enctype="multipart/form-data">
                     @CSRF
            ...
            <div class="card">
              <!-- Card header -->
              <div class="card-header">
                <h3 class="mb-0">Stores Items List</h3>
              </div>
              <!-- Card body -->
            <!--  <div class="card-body">-->
            ...
            <!--        <th>-->
            <!--            <p>-->
            <!--                {{ $list->stock == '1' ? 'Available' : 'Out Of Stock' }}-->
            <!--                </p>-->
                        
                        
            <!--        </th>-->
            <!--        <td>{{$list->price}} Rs</td>-->
            <!--        <td><img src={{$list->images}} height="50px"/></td>-->
            <!--        </tr>-->
            <!--            @empty-->
            <!--          <tr>-->
            <!--            <td>-->
