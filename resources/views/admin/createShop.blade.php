          ...
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <h3 class="mb-0">Create New Shop</h3>
              </div>
              <!-- Card body -->
              <div class="card-body">
                ...
                <form action="{{url('/admin/shop/registered')}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                    <div class="col-md-4 mb-3" {{ $errors->has('shop_owner') ? 'has-error' : '' }}>
                      ...
                      <input type="text" class="form-control" id="validationCustom01" name="shop_owner" value="{{ old('shop_owner') }}"  placeholder="Please enter owner name">
                    ...
                    <div class="col-md-4 mb-3" {{ $errors->has('shop_name') ? 'has-error' : '' }}>
                      ...
                      <input type="text" class="form-control" id="validationCustom02" name="shop_name" value="{{ old('shop_name') }}" placeholder="Please enter shop name">
                    ...
                    <div class="col-md-4 mb-3" {{ $errors->has('sale_type') ? 'has-error' : '' }}>
                      ...
                      <input type="text" class="form-control" id="validationCustomUsername" name="sale_type" value="{{ old('sale_type') }}" placeholder="Please enter sale types" aria-describedby="inputGroupPrepend">
                     ...
                     <div class="form-row">
                      ...
                      <input type="text" class="form-control" id="validationCustomUsername" name="shop_address" value="{{ old('shop_address') }}"  placeholder="Please enter shop Address"  aria-describedby="inputGroupPrepend">
