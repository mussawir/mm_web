...
<div class="row">
	<div class="col-xxl">
		<div class="card">
			<div class="card-body">
				<form method="POST" action="/admin/vendor-types/{{ $vendorType->id }}">
					@csrf
					@method('PUT')
					<div class="row mb-3">
						...
						<div class="col-sm-10">
							<input
								...
								aria-required="true"
								value="{{ old('type_name', $vendorType->type_name) }}"
							>
						...
						<div class="col-sm-10">
							<div class="form-check form-check-inline">
								<input
									...
									id="yes"
									aria-required="true"
									{{ (old('is_food', $vendorType->is_food) == '1') ? 'checked' : '' }}
								>
							...
							<div class="form-check form-check-inline">
								<input
									...
									id="no"
									aria-required="true"
									{{ (old('is_food', $vendorType->is_food) == '0') ? 'checked' : '' }}
								>
