				...
				<div class="lane-wrapper owl-carousel owl-theme deals-carousel {{ $deals->count() ? '' : 'd-none' }}" id="dealsCarousel">
					...
					>
						...
						<div class="card-body vstack justify-content-end">
							<h3 class="truncate product-tile__title cl-interaction-primary f-title-small-font-size fw-title-small-font-weight lh-title-small-line-height ff-title-small-font-family">
