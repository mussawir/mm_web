		...
		<div class="modal-content">
			<div class="modal-body mt-5 d-flex justify-content-center">
				<div class="vstack align-items-center">
					<img class="bg-secondary-subtle p-2 rounded-pill" src="{{ asset('assets/images/avatars/mazamax.svg') }}" width="100" height="100" alt="Brand Logo">
					<div class="card-body w-75 mt-4">
						<h5 class="card-title text-center" id="cardTitle">
							Your location
						</h5>
						<div class="btn-group gap-3 mt-3 d-flex justify-content-center" role="group" aria-label="Basic radio toggle button group">
