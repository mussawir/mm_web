...
class CheckoutController extends Controller
{
	public function index(Request $request)
	{
		...
		if (Auth::guard('customer')->check()) {
			...
			return view('front.checkout', compact('deliveryCharges', 'minimumOrderCheck', 'minimumOrderAmount', 'deliveryFreeAfer'));
		}
		else {
	...
	public function checkout(Request $request)
	{
		...
		// $this->saveUserContactInfo($validatedData);
		...
		if (count(session('cart', []))) {
			...
			$orderAddress = $request->input('address_address');
	...
	private function saveUserContactInfo($userData)
	{
		if (auth()->check()) {
